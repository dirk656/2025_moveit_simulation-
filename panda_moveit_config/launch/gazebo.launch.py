...
def generate_launch_description():
    ...
    # Launch the robot, 通过robot_description话题进行模型内容获取从而在gz sim中生成模型
    spawn_entity_cmd = Node(
        package='ros_gz_sim', 
        executable='create',
        arguments=['-topic', '/robot_description', '-name', robot_name_in_model], output='screen')
